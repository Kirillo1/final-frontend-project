            ...
            <section className="card-details">
                <div className="max-w-7xl mx-auto px-2">
                    ...
                    <div className="flex flex-row">
                        <div className="basis-1/2">
                            <div className="py-4">
                                <p className="text-gray-600 text-sm mb-2"><ColorLensTwoToneIcon sx={{ color: "rgb(124 58 237)" }} /> Цвет: {accessoryDetail?.color}</p>
                                <p className="text-gray-600 text-sm mb-2"><PublicTwoToneIcon sx={{ color: "rgb(124 58 237)" }} /> Страна производства: {accessoryDetail?.manufacturer_country}</p>
                                <p className="text-gray-600 text-sm mb-2"><InfoRoundedIcon sx={{ color: "rgb(124 58 237)" }} /> Описание: {accessoryDetail?.description}</p>
                                <p className="text-gray-600 text-2xl mt-5">{accessoryDetail?.price} <CurrencyRubleTwoToneIcon /></p>
                            </div>
                            {user && (accessoryDetail?.user_id === user?.id) && (
                                <div className="mt-5">
                                    <ButtonGroup variant="outlined" aria-label="Loading button group">
                                        <Button onClick={() => console.log(accessoryDetail.id)}>Изменить</Button>
                                        <Button>
                                            <DeleteForeverTwoToneIcon sx={{ color: "#c1121f" }} onClick={() => onDeleteButtonClick(accessoryDetail.id)} />
                                        </Button>
                                    </ButtonGroup>
                                </div>
                            )}
                        ...
                        <div className="basis-1/8">
                            <ImageList sx={{ width: 700, height: 500 }} cols={3} rowHeight={200}>
                                {accessoryDetail?.images && accessoryDetail.images.length > 0 ? (
