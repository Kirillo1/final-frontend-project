    ...
    return (
        <footer className="w-full">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-8 py-2 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        <h4 className="text-zinc-300 text-xl">
                            MobileGuru
                        </h4>

                        <div className="flex py-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                            <a
                                href="#"
                                className="w-9 h-9 rounded-full bg-violet-700 flex justify-center items-center hover:bg-violet-800"
                            >
                                <svg
                                    className="w-[1.25rem] h-[1.125rem] text-zinc-300"
                                    viewBox="0 0 15 15"
                                    fill="none"
                            ...
                            >
                                <svg
                                    className="w-[1rem] h-[1rem] text-zinc-300"
                                    viewBox="0 0 13 12"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                            ...
                            >
                                <svg
                                    className="w-[1.25rem] h-[0.875rem] text-zinc-300"
                                    viewBox="0 0 16 12"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
